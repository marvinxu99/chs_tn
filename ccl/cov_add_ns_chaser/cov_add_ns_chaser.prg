...
set stat = (SetProcOrderDetailValue("Combination Dosing Ingredient",0,0,15,0,1)) 
set stat = (SetProcOrderDetailValue("Strength Dose",0,0,15,1,1)) 
set stat = (SetProcOrderDetailValueCd("Strength Dose Unit",0.0,0,15,2)) 
set stat = (SetProcOrderDetailValue("Volume Dose",30,1,15,3,1)) 
...
set stat = (SetProcOrderDetailValue("Drug Form",0,0,25,1)) 
...
set stat = (SetProcOrderDetailValue("PAR Doses",0,0,70,1))
