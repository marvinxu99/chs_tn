...
******************************************************************************/
drop program dev_cov_provider_handoff_print go
create program dev_cov_provider_handoff_print
...
elseif (t_rec->detail_ind in(2,3))
	...
	if (t_rec->detail_ind = 2)
		set print_options->CUST_PRINT_CCL = "dev_chs_wklist_cust_print_temp"
	elseif (t_rec->detail_ind = 3)
		set print_options->CUST_PRINT_CCL = "dev_chs_wklist_prov_grplist"
	endif
