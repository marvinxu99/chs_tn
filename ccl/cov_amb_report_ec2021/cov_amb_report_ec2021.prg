...
set t_rec->4_start_dt				= format(datetimefind(cnvtdatetime("01-MAY-2021 00:00:00"),'M','B','B'),"DD-MMM-YYYY;;q")
set t_rec->5_end_dt					= ^26-APR-2022^
set t_rec->5_end_dt					= format(datetimefind(cnvtdatetime("01-MAY-2021 00:00:00"),'M','E','E'),"DD-MMM-YYYY;;q")
